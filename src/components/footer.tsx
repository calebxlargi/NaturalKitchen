...
export function Footer() {
  return <footer className="site-footer">
    <div className="container footer-top">
      <div><Link href="/" className="wordmark" aria-label="Natural Kitchen home"><Image src="/images/nk_logo.png" alt="" width={2000} height={600} /></Link><p>Good food. In good company.</p></div>
